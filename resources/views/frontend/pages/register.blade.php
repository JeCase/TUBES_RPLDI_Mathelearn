...
@section('title','Mathelearn || Daftar')
            ...
            <div class="row">
                <div class="col-12">
                    <div class="bread-inner">
                        <ul class="bread-list">
                            <li><a href="{{route('home')}}">Halaman Utama<i class="ti-arrow-right"></i></a></li>
                    ...
                    <div class="login-form">
                        ...
                        <form class="form" method="post" action="{{route('register.submit')}}">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        <label>Masukkan Kata Sandi<span>*</span></label>
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        <label>Ulangi Kata Sandi<span>*</span></label>
